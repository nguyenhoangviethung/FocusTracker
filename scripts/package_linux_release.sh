...
test -s "${project_root}/models/triple_xgb_depth_robust_target_band_product/fusion_config.json" || {
  echo "Missing models/triple_xgb_depth_robust_target_band_product. Run scripts/download_triple_xgb_product.py first." >&2
  exit 1
}
