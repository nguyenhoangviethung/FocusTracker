...
class ActiveWindowTracker:
    ...
    def build_permission_prompt(self) -> str:
        return (
            "Ứng dụng cần quyền đọc ứng dụng/cửa sổ đang active để hợp nhất AI với heuristic hệ điều hành. "
            "Dữ liệu này chỉ dùng để xác định trạng thái tập trung, không đọc nội dung tài liệu hay ghi phím."
        )
